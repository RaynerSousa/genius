...
export const AnimatedTestimonials = ({
  ...
  // Predefined rotations to avoid Math.random() during SSR
  const predefinedRotations = [-5, 3, -2, 4, -3, 2, -4, 5, -1, 6];
          ...
          <div className="flex flex-col justify-between py-4">
            ...
            <div className="flex gap-4 pt-12 md:pt-0">
              <button className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gray-100 dark:bg-neutral-800">
                <ChevronLeft className="h-5 w-5 text-black dark:text-neutral-400" />
              </button>
              <button className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gray-100 dark:bg-neutral-800">
                <ChevronRight className="h-5 w-5 text-black dark:text-neutral-400" />
              </button>
            </div>
          </div>
        </div>
